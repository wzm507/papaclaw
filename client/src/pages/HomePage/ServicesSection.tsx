...
import { ZapIcon, GlobeIcon, CompassIcon, Building2Icon, WalletIcon } from 'lucide-react';
          ...
          {businesses.map((biz, index) => (
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="mb-8 lg:mb-12">
                <div className="inline-flex items-center gap-3 px-4 py-2 md:px-5 md:py-2.5 rounded-lg bg-primary/10 text-primary text-sm md:text-base font-medium mb-4 md:mb-6">
                  {biz.icon}
                  <span>{biz.label}</span>
                </div>
              ...
              {biz.painPoint && (
                <motion.div variants={fadeInUp} className="mb-8 lg:mb-12">
                  <div className="bg-muted/50 border border-border rounded-xl p-5 md:p-6 lg:p-8">
                ...
                {biz.steps.map((step, stepIndex) => (
                  <motion.div key={stepIndex} variants={fadeInUp}>
                    <div className="flex gap-4 md:gap-6">
                      <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 rounded-full bg-primary/10 text-primary flex items-center justify-center text-base md:text-lg font-bold">
                        {stepIndex + 1}
                      </div>
                      <div className="flex-1 min-w-0">
                        <h4 className="text-base md:text-lg lg:text-xl font-semibold text-foreground mb-2 md:mb-3">{step.title}</h4>
                ...
                <motion.div variants={fadeInUp} className="mb-6 lg:mb-8">
                  <div className="flex flex-wrap gap-2 md:gap-3">
                    {biz.regions.map((region, i) => (
                      <span
                        key={i}
                        className="inline-flex items-center px-4 py-2 md:px-5 md:py-2.5 rounded-lg bg-primary/5 text-primary text-sm font-medium border border-primary/10"
                      >
                        {region}
                      </span>
                    ))}
              ...
              <motion.div variants={fadeInUp}>
                <div className="bg-gradient-to-r from-primary/5 to-success/5 border border-primary/10 rounded-xl p-5 md:p-6 lg:p-8">
